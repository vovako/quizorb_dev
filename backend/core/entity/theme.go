...
func SetThemes() []Theme {
	return []Theme{
		...
		{ID: 2, Title: "Тема 2", Answer: "Толстой Л.Н.", IMGAnswer: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYLa3Rd_S6ZMlpClpBgjMrKIlEAw4KD9MgCQ&usqp=CAU"},
		{ID: 3, Title: "Тема 3", Answer: "Некрасов Н.А.", IMGAnswer: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR172aaVb-noxDg6Bkkr20gpjNC8qB-2FuXtg&usqp=CAU"},
